...
@section('page_subtitle','Kelola data petugas lapangan')
        ...
        <form method="GET" class="flex gap-3 items-end">
            <div class="relative">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama / NIP..."
                    class="pl-9 pr-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-800 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all w-56">
            ...
            <button type="submit"
                class="px-4 py-2.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold rounded-xl shadow transition-all">
                Cari
            </button>
        </form>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-50 dark:bg-gray-800/60">
                    ...
                    <th class="text-left px-3 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider">NIP / Jabatan</th>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-all duration-150">
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0 shadow">
                    ...
                    <td class="px-3 py-3.5 text-center text-xs text-gray-500">
                        {{ $p->no_hp ?? '-' }}
                    </td>
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center justify-center gap-1.5">
                            ...
                            <form method="POST" action="{{ route('admin.petugas.destroy', $p) }}"
                                onsubmit="return confirm('Hapus petugas {{ $p->nama_petugas }}?')">
                                @csrf @method('DELETE')
                                <button type="submit"
