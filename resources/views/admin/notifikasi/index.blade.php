...
<div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
    ...
    <div class="divide-y divide-gray-100 dark:divide-gray-800">
        ...
        <div class="flex items-start gap-4 px-5 py-4 transition-all duration-200
            hover:bg-gray-50 dark:hover:bg-gray-800/60
            {{ !$n->sudah_dibaca ? 'bg-brand-50/50 dark:bg-brand-900/10' : '' }}">
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <div class="space-y-1">
                        <p class="text-sm text-gray-800 dark:text-gray-200
                            {{ !$n->sudah_dibaca ? 'font-bold' : 'font-medium' }}">
        ...
        <div class="py-24 text-center">
            <svg class="w-16 h-16 text-gray-200 dark:text-gray-700 mx-auto mb-4"
