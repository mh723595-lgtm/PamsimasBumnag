...
<head>
    ...
    <title>PAMSIMAS – Sistem Air Minum Berbasis </title>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 -mt-0.5 hidden sm:block">Sistem Air Minum Masyarakat</p>
                    </div>
                </div>

                <!-- Nav Links Desktop -->
                <div class="hidden md:flex items-center gap-1">
                    <a href="#fitur" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/30 transition-all">Fitur</a>
                    <a href="#statistik" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/30 transition-all">Statistik</a>
                    <a href="#cara-kerja" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/30 transition-all">Cara Kerja</a>
                    <a href="#testimoni" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/30 transition-all">Testimoni</a>
                </div>

                <!-- Right Actions -->
                <div class="flex items-center gap-2">
                    <!-- Dark Mode Toggle -->
                    <button @click="darkMode = !darkMode" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
                    ...
                    <div class="relative w-full max-w-sm animate-float">
                        ...
                        <div class="glass-card rounded-3xl p-6 shadow-2xl">
                            ...
                            <div class="flex items-end gap-1.5 h-20 mb-4">
                                ...
                                <div class="flex-1 rounded-t-sm bg-gradient-to-t from-brand-400/60 to-white/40" style="height: {{ $h }}%"></div>
                                @endforeach
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                ...
                <div class="stat-card glass-card rounded-2xl p-6 transition-all duration-300 cursor-default">
                    ...
                    <p class="text-white/60 text-sm mb-1">{{ $s['label'] }}</p>
                    <p class="text-white font-extrabold text-2xl counter mb-1">{{ $s['value'] }}</p>
                    <p class="text-brand-300 text-xs">{{ $s['change'] }}</p>
                </div>
                @endforeach
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                ...
                <div class="relative text-center">
                    ...
                    <div class="relative z-10 inline-flex flex-col items-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-[200px]">{{ $step['desc'] }}</p>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                $testimonials = [
                    ...
                    ['name' => 'Ahmad Fauzi', 'role' => 'Petugas Lapangan', 'avatar' => 'AF', 'color' => 'from-green-500 to-teal-600', 'text' => 'Petugas lapangan mencatat angka meter air pelanggan setiap bulan secara akurat melalui sistem, sehingga data pemakaian tercatat dengan rapi dan valid.', 'rating' => 5],
                ];
                @endphp
                ...
                <div class="testi-card bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 relative">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6 italic">"{{ $t['text'] }}"</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-gradient-to-br {{ $t['color'] }} flex items-center justify-center text-white font-bold text-sm">{{ $t['avatar'] }}</div>
                        <div>
